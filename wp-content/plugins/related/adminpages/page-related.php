...
function related_options_page() {
	...
	if ( isset( $_POST['form'] ) ) {
		if ( function_exists('current_user_can') && ! current_user_can('manage_options') ) {
			die( esc_html__('Cheatin&#8217; uh?','related' ));
		}
	...
	<div role="tabpanel" class="related_options related_about">
		<div class="poststuff metabox-holder">
			<div class="related-widget">
				<h3><?php esc_html_e('About this plugin.', 'related'); ?></h3>
				<p><?php
					$link = 'http://zenoweb.nl';
					$name = 'ZenoWeb';
					echo sprintf( esc_html__( 'This plugin is being maintained by Marcel Pol from <a href="%s" target="_blank">%s</a>.', 'related' ), $link, $name ); ?>
				</p>
				...
				<p><?php
					...
					echo sprintf( esc_html__( 'If this plugin has any value to you, then please leave a review at <a href="%s" target="_blank">the plugin page at wordpress.org</a>.', 'related' ), $link ); ?>
				</p>

				<h3><?php esc_html_e('Donate to the maintainer.', 'related'); ?></h3>
				<p><?php
